...
app.post("/githubUpdate", async (req, res) => {
  ...
  //reporsitory = 
  shell.exec(`git clone "https://clientaccess@connex.digital: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@github.com/connex-clientaccess/dynamic-app"`)
  shell.exec(`git clone "https://clientaccess@connex.digital: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@github.com/grindery-io/grindery-nexus-schema-v2"`)
